#!/bin/bash
# Aperture Science Terminal Greeting
# Displays ASCII logo + random GLaDOS quote

BLUE='\033[38;2;0;161;228m'
...
echo ""
echo -e "${BLUE}     ╭─────────────────────────────────────╮${RESET}"
echo -e "${BLUE}     │${WHITE}    ◉  APERTURE  SCIENCE             ${BLUE}│${RESET}"
echo -e "${BLUE}     │${DIM}       ENRICHMENT CENTER              ${BLUE}│${RESET}"
echo -e "${BLUE}     ╰─────────────────────────────────────╯${RESET}"
...
echo ""
echo -e "${DIM}  \"${WHITE}${quote}${DIM}\"${RESET}"
echo -e "${DIM}                                    — GLaDOS${RESET}"
echo ""
